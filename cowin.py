...
receivers = ['tanuj17118@iiitd.ac.in', 'pravek17256@iiitd.ac.in', 'ashwin.singh.gill@gmail.com']
...
def send_email(message):
	...
	server.starttls()
	server.ehlo()
	server.login('tanujdabas@gmail.com', 'ohmyfuckinggodlogmeinalready')
	server.sendmail('tanujdabas@gmail.com', receivers, message)
	server.close()
